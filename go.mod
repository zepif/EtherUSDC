module github.com/zepif/EtherUSDC
...
require (
	...
	github.com/zepif/Test-service v0.0.0-20240514151838-f34d5a8ec857
...
require (
	...
	gitlab.com/distributed_lab/figure v2.1.1+incompatible // indirect
